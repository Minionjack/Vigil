// VENDORED from packages/core/src/dateTz.ts — verbatim, no changes needed
// (no internal imports to rewrite). See _shared/core/README.md for why
// this copy exists instead of importing packages/core directly.
