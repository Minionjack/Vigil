// VENDORED from packages/core/src/nextSession.ts — only change is the
// import extension (./dateTz.js -> ./dateTz.ts, Deno-correct). See
// _shared/core/README.md for why this copy exists instead of importing
// packages/core directly.
import { addDays, weekdayOfDateString } from "./dateTz.ts";
