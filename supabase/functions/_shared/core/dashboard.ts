// VENDORED from packages/core/src/dashboard.ts — only change is the
// import extensions (./dateTz.js -> ./dateTz.ts, ./stats.js ->
// ./stats.ts, Deno-correct). See _shared/core/README.md for why this
// copy exists instead of importing packages/core directly.
import { daysBetween, mondayOfWeek, addDays } from "./dateTz.ts";
import type { CoreSession } from "./stats.ts";
